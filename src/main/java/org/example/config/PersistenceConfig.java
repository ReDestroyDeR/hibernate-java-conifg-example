...
public class PersistenceConfig {
    ...
    public DataSource dataSource() {
        ...
        dataSource.setDriverClassName(configurationProperties.getDriverClass());
        dataSource.setUsername(configurationProperties.getUser());
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setJpaProperties(configurationProperties.getAdditionalProperties());
